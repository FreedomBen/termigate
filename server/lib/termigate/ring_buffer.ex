defmodule Termigate.RingBuffer do
  @moduledoc """
  ...
  def new(capacity \\ nil) do
    ...
    max_size = Application.get_env(:termigate, :ring_buffer_max_size, 8_388_608)
    default_size = Application.get_env(:termigate, :ring_buffer_default_size, 2_097_152)

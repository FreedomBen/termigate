defmodule Termigate.SessionPoller do
  @moduledoc """
  ...
  defp fetch_panes(sessions) do
    Enum.map(sessions, fn session ->
      panes =
        case Termigate.TmuxManager.list_panes(session.name) do
  ...
  defp schedule_poll(state) do
    interval = Application.get_env(:termigate, :session_poll_interval, 3_000)

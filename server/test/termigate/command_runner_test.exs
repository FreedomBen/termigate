defmodule Termigate.Tmux.CommandRunnerTest do
  ...
  describe "run/1" do
    ...
    test "prepends socket args when configured" do
      original = Application.get_env(:termigate, :tmux_socket)

      try do
        Application.put_env(:termigate, :tmux_socket, "/tmp/test-tmux-sock")
      ...
      after
        if original,
          do: Application.put_env(:termigate, :tmux_socket, original),
          else: Application.delete_env(:termigate, :tmux_socket)
      end
    end
  end

defmodule TmuxRm.RingBufferTest do
  ...
  describe "new/1" do
    ...
    test "clamps capacity to min size" do
      ...
      min = Application.get_env(:tmux_rm, :ring_buffer_min_size, 524_288)
      assert buf.capacity == min
    end

    test "clamps capacity to max size" do
      buf = RingBuffer.new(100_000_000)
      max = Application.get_env(:tmux_rm, :ring_buffer_max_size, 8_388_608)

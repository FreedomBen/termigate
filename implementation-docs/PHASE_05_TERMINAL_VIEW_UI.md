...
**`server/lib/termigate_web/live/terminal_live.ex`**:
...
**`server/lib/termigate_web/live/terminal_live.html.heex`**:
...
**Template meta tag** (in `server/lib/termigate_web/live/terminal_live.html.heex`):
```heex
...
**UserSocket**: Phase 5 creates `server/lib/termigate_web/channels/user_socket.ex` as a stub (no auth verification — pass-through `connect/3`). Phase 6 adds token verification to `connect/3`. Phase 11 adds the `channel "sessions", SessionChannel` registration. The initial Phase 5 UserSocket:
```elixir
...
server/lib/termigate_web/live/terminal_live.ex
server/lib/termigate_web/live/terminal_live.html.heex
server/lib/termigate_web/channels/terminal_channel.ex (core TerminalChannel — extended in Phase 11)
server/lib/termigate_web/channels/user_socket.ex (update — register terminal:* channel)
server/lib/termigate_web/router.ex (update routes)
server/test/termigate_web/live/terminal_live_test.exs

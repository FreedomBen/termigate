...
**`server/lib/termigate/pane_stream.ex`**:
...
FIFO path: `/tmp/termigate/pane-{pane_id}.fifo` (e.g., `/tmp/termigate/pane-%0.fifo`)
...
**`server/lib/termigate/pane_stream_supervisor.ex`**:

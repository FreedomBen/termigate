...
**`server/lib/termigate/session_poller.ex`**:
...
**`server/lib/termigate_web/live/session_list_live.ex`**:
...
**Template** (`server/lib/termigate_web/live/session_list_live.html.heex`):
...
**`server/lib/termigate_web/controllers/health_controller.ex`**:
...
server/lib/termigate/session_poller.ex
server/lib/termigate_web/live/session_list_live.ex
server/lib/termigate_web/live/session_list_live.html.heex
server/lib/termigate_web/controllers/health_controller.ex
server/lib/termigate_web/router.ex (add routes)
